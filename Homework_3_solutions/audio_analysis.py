...
# approach. The code fragment smoothing.py can be found at 
# http://www.scipy.org/Cookbook/SignalSmooth
from smoothing import smooth

# Before diving in, we define some functions for fitting data to a 
# Cauchy-Lortentz distribution. Using scipy.optimize and generalizations of 
# these function defintions one can fit data to any equation. In this case, 
# the power spectrum peaks of the audio are well fit by Cauchy-Lortentz curves.
...
for input_filename in file_list:
    ...
    if audio_file_flag:
        ...
        # The amplitude vs time plot is easy.
        ...
        notes_file.close()
        # Now we go through all the notes and fit each. If a signitificant peak
