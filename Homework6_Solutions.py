...
# We'll use this 3rd party image search module.
# Get it from http://sourceforge.net/projects/pysearch/files/
from yahoo.search.image import ImageSearch
# We'll use urllib2 to access the images on the web
import urllib2
...
# supplied with the Week 6 resources to provide a matplotlib canvas embedding
# solution.
...
class Application(HasTraits):
    ...
    # default value, but this is not strickly necessary.
    ...
    traits_view = View( 
        ...
        title   = 'Yahoo! Image Search and Manipulation',
